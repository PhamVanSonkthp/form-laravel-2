...
class MakeViewRow extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'make:viewrow {name}';
...
//    }
    ...
    public function handle()
    {
        ...
        $path = base_path() . '/resources/views/administrator/'. Formatter::toUnderline($this->repositoryClass) . "s/row.blade.php";
...
//        return app_path() . '/Models/Repository.stub';
        return base_path(). '/stubs/make_view_row.stub';
    }
