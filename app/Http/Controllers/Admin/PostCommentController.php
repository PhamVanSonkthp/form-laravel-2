...
class PostCommentController extends Controller
{
    ...
    public function __construct(PostComment $model)
    {
        ...
        $postCommentStatuses = PostCommentStatus::all();
        View::share('postCommentStatuses', $postCommentStatuses);
    }
    ...
    public function audit(Request $request, $id)
    {
        ...
        $items = $auditModel->searchByQuery($request, ['auditable_id' => $id, 'auditable_type' => 'App\Models\PostComment'], null, null, true);
