...
return [
    ...
    'table_module'=>[
        ...
        'products',
        'user_types',
        'f_a_q_s','posts','post_comments','reason_cancels','app_versions',/*step_2*/
    ],
    ...
    'table_module_name'=>[
        ...
        'Manage f_a_q_s','Manage posts','Manage post_comments','Manage reason_cancels','Manage app_versions',/*step_3*/
    ],
