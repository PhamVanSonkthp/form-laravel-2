    ...
    <div class="navbar-content">
        <div class="search-form" style="width: auto;">
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="input_search_method" placeholder="Tìm kiếm..." oninput="onSearchMethod()">
            </div>
        </div>
        <ul class="navbar-nav">

            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="languageDropdown_1" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    {{\App\Models\Helper::getWeather(request()->ip())}}
                     <span class="ms-1 me-1 d-none d-md-inline-block">Thời tiết</span>
                </a>
            ...
            <li class="nav-item dropdown">
                <span class="ms-1 me-1 d-none d-md-inline-block">
                    ...
                    {{round(\App\Models\Helper::diskTotalSize(),2)}} GB  <span class="{{\App\Models\Helper::diskUsed() > 50 && \App\Models\Helper::diskUsed() < 90 ? 'text-warning' : ""}} {{\App\Models\Helper::diskUsed() >= 90 ? 'text-danger' : ''}}">({{\App\Models\Helper::diskUsed()}})</span></span>
            </li>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="languageDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="flag-icon flag-icon-vn mt-1" title="us"></i> <span class="ms-1 me-1 d-none d-md-inline-block">Tiếng Việt</span>
                </a>
