            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle"  role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="ms-1 me-1 d-none d-md-inline-block">
                        {{round(\App\Models\Helper::diskUsedSize(),2)}} GB /
        {{round(\App\Models\Helper::diskTotalSize(),2)}} GB ({{\App\Models\Helper::diskUsed()}})</span>
                </a>
            </li>

            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle"  role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="ms-1 me-1 d-none d-md-inline-block">{{\Carbon\Carbon::now()->toDateTimeString()}}</span>
                </a>
            </li>
