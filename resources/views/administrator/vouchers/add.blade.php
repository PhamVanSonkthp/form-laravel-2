                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group mt-3">
                                <label>Loại giảm giá | Mức
                                    giảm @include('administrator.components.lable_require') </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input type="text" autocomplete="off" name="discount_amount"
                                               class="form-control number @error("discount_amount") is-invalid @enderror"
                                               placeholder="Giảm theo số tiền">

                                        <input style="display: none;" type="text" autocomplete="off"
                                               name="discount_percent"
                                               class="form-control number @error("discount_percent") is-invalid @enderror"
                                               placeholder="Giảm theo %">

                                        <input style="display: none;" type="text" autocomplete="off"
                                               name="max_discount_percent_amount"
                                               class="form-control number mt-3 @error("discount_percent") is-invalid @enderror"
